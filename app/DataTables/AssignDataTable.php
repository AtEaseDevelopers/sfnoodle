...
class AssignDataTable extends DataTable
{
        ...
        return $this->builder()
            ...
            ->parameters([
                ...
                'buttons'   => [
                    ...
                    ['extend' => 'excelHtml5','text'=>'<i class="fa fa-file-excel-o"></i> Excel','exportOptions'=> ['columns'=>':visible:not(:last-child)'], 'className' => 'btn btn-default btn-sm no-corner','title'=>null,'filename'=>'assign'.date('dmYHis')],
                    ['extend' => 'pdfHtml5', 'orientation' => 'landscape', 'pageSize' => 'LEGAL','text'=>'<i class="fa fa-file-pdf-o"></i> PDF','exportOptions'=> ['columns'=>':visible:not(:last-child)'], 'className' => 'btn btn-default btn-sm no-corner','title'=>null,'filename'=>'assign'.date('dmYHis')],
    ...
    protected function getColumns()
    {
        return [
            ...
            'driver_id'=> new \Yajra\DataTables\Html\Column(['title' => 'Driver Name',
            'data' => 'driver.name',
            'name' => 'driver.name']),

            'customer_id'=> new \Yajra\DataTables\Html\Column(['title' => 'Customer Company',
