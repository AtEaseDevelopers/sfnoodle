    ...
    <div id="editRequest" class="modal fade">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    {!! Form::open(['route' => ['inventoryReturns.update', ':id'], 'method' => 'PUT', 'enctype' => 'multipart/form-data', 'id' => 'editRequestForm']) !!}
...
<script>
    $(document).ready(function () {
        ...
        function updateRequestQuantity(requestId, newQuantity) {
            ...
            $.ajax({
                url: '{{ route("inventoryReturns.update", ":id") }}'.replace(':id', requestId),
                type: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
